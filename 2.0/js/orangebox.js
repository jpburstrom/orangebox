                    ...
                    function setModalProperties() {
                        ...
                        if(obj.data('ob_data').ob_linkText) {
                            if(obj.data('ob_data').ob_link){
                                ...
                                else if(obj.data('ob_data').ob_linkTarget === "lightbox") { rel = 'rel="lightboxlink"'; }
                ...
                //Update Navigation
                    function setControls() {
                        ...
                        if(oB.settings.orangeControls) {
                            $(document).unbind('oc_right').unbind('oc_left').unbind('oc_pause').unbind('oc_play');
                            ...
                            else { $(document).unbind('oc_pause').unbind('oc_play'); }
                ...
                //Build the Window
                    function buildit() {
                        ...
                        $('a[rel*=lightboxlink]').click(function(e){
                            ...
                            if(obj.data('ob_data').ob_index) { obj = oB.galleryArray[obj.data('ob_data').ob_index]; }
